...
import { verifyCaptchaAnswer } from "./captcha.js";
...
const handleSubscribe = async (
  payload,
  {
    submitLeadFn = submitLead,
    getConfig = getSupabaseConfig,
    verifyCaptchaFn = verifyCaptchaAnswer,
    captchaToken,
  } = {}
) => {
  ...
  if (!verifyCaptchaFn(payload.captcha, captchaToken)) {
    return {
      status: 400,
      message: "Resposta do captcha inválida. Tente novamente.",
    };
  }
